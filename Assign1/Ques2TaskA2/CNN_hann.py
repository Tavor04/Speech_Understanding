...
class UrbanSoundDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        try:
            ...
            # ✅ Define Hann Window inside __getitem__
            hann_window = torch.hann_window(self.n_fft)  # Correctly created inside the function
            
            # ✅ Apply Hann Window & Compute Spectrogram
            spectrogram = torch.stft(
                waveform,
                n_fft=self.n_fft,
                hop_length=self.hop_length,
                window=hann_window,  # ✅ Fix: Use local hann_window, NOT self.hann_window
...
dataset = UrbanSoundDataset("/Users/malik/Downloads/Projects/Speech Understanding Projects/windowing/UrbanSound8K/metadata/UrbanSound8K.csv", root_dir)
...
# Load full dataset
full_dataset = UrbanSoundDataset(
