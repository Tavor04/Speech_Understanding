...
class UrbanSoundDatasetHamming(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        try:
            ...
            hamming_window = torch.hamming_window(self.n_fft)  # Hamming window function

            # ✅ Apply Hamming Window & Compute Spectrogram
            spectrogram = torch.stft(
                waveform,
                n_fft=self.n_fft,
                hop_length=self.hop_length,
                window=hamming_window,  # ✅ Fix: Use hamming window
...
dataset = UrbanSoundDatasetHamming("/Users/malik/Downloads/Projects/Speech Understanding Projects/windowing/UrbanSound8K/metadata/UrbanSound8K.csv", root_dir)
...
# Load full dataset
full_dataset = UrbanSoundDatasetHamming(
